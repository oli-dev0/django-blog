...
- `test_embed_sharing_styling.py`: shared and example host stylesheet
...
- `test_views.py`: public shells, example unprefixed Blog routes and the product test site's
