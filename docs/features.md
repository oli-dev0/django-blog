...
- **Site-owned shells:** Hosts can use the neutral app-owned `blog` frontend or supply custom shells. Public routes and enabled sites come from the host registry.
