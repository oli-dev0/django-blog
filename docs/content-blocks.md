...
Embed presentation is owned by `blog/static/blog/css/article.css`. Custom
host stylesheets must preserve the responsive embed rules. The contract includes bounded provider widths, rounded
