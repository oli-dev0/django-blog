...
- Example unprefixed Blog: `/blog/`, `/blog/tag/<slug>/`,
  `/blog/category/<slug>/`, `/blog/author/<author_slug>/`,
  `/blog/<slug>/`, and `/blog/rss/`.
- Example prefixed Blog: the same route family under `/en/blog/`.
...
- Enabled sites: declared by the host registry; no production registry is bundled.
...
Only English Blog content is supported. The host chooses an unprefixed or
English-prefixed route family and its canonical URLs.
