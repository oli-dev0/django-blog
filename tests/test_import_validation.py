...
def minimal_payload(
    *,
    ...
    article = {
        ...
        "publication_sites": publication_sites or ["product_site"],
...
def all_block_payload():
    payload = minimal_payload(
        ...
        blocks=[
            ...
            {"type": "internal_link", "destination_key": "product-home", "label": "Product home"},
            {"type": "image", "asset_id": "hero"},
            {"type": "image_comparison", "comparison_id": "comparison"},
        ]
    )
...
class BlogImportValidationTests(TestCase):
    def setUp(self):
        ...
        site, _created = BlogSite.objects.get_or_create(slug="product_site")
    ...
    def test_exact_reference_resolution_does_not_fuzzy_match(self):
        ...
        BlogPostPublication.objects.create(post=related, site_slug="product_site")
        ...
        self.assertEqual(references.resolved_publication_sites, ("product_site",))
        ...
        unresolved = resolve_blog_import_references(
            validate_blog_import(
                minimal_payload(
                    author="example-author-foo",
                    category="development-foo",
                    tags=["django-foo"],
                    publication_sites=["product-admin"],
                    canonical_site="product-admin",
                )
            ).parsed
        )
    ...
    def test_reviewed_choices_restrict_canonical_site_and_revalidate_site_dependencies(self):
            ...
            with self.allow_all_permissions():
                invalid = validate_reviewed_blog_import(
                    session,
                    {
                        ...
                        "tags": [],
                        "publication_sites": ["product_site", "personal_site"],
                        "canonical_site": "product_site",
        ...
        self.assertEqual(valid.references.publication_sites, ("product_site",))
    ...
    def test_review_rechecks_changed_site_dependencies(self):
        ...
        publication = BlogPostPublication.objects.create(post=related, site_slug="product_site")
