...
class BlogImportContractTests(TestCase):
    ...
    def test_documented_defaults_and_normalization_do_not_add_django_owned_fields(self):
        ...
        self.assertEqual(article.canonical_site, 'product_site')
    ...
    def test_meaningful_content_rules_reject_empty_or_unsafe_block_content(self):
        cases = (
            ...
            ('generic internal link', {'type': 'internal_link', 'destination_key': 'product-features', 'label': ' Click here '}, 'generic_internal_link_label', 'article.blocks[0].label'),
