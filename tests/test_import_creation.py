...
class BlogImportCreationTests(TestCase):
    ...
    def create_related_post(self, slug):
        ...
        BlogPostPublication.objects.create(post=post, site_slug='product_site')
        return post
    ...
    def test_image_free_payload_creates_draft_metadata_relationships_and_all_blocks_in_order(self):
        ...
        blocks = [
            {'type': 'heading', 'level': 2, 'text': 'Same heading'},
            {
                ...
                'body': (
                    ...
                    '<a data-blog-internal-key="product-home">Product</a></p>'
                ),
            },
            {
                'type': 'faq',
            ...
            {
                'type': 'internal_link',
                'destination_key': 'product-home',
                'label': 'Product Site home',
        ...
        self.assertEqual(post.canonical_site_slug, 'product_site')
        ...
        self.assertIn('data-blog-internal-key="product-home"', rich_text.body)
