...
class BlogTaxonomyWebsiteMigrationTests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        old_apps.get_model('blog', 'BlogPostPublication').objects.create(
            post=post, site_slug='personal_site'
        )
    ...
    def test_existing_terms_gain_only_current_publication_sites(self):
        category_sites = set(
        ...
        self.assertEqual(category_sites, {'personal_site'})
        self.assertEqual(tag_sites, {'personal_site'})
